...
// constexpr COLORREF GAMEPAD_USB = rgb(46, 139, 87);
// constexpr COLORREF GAMEPAD_BT = rgb(30, 144, 255);
constexpr COLORREF GAMEPAD_USB = BRIGHT_GREEN;
constexpr COLORREF GAMEPAD_BT = BRIGHT_BLUE;
constexpr COLORREF GAMEPAD_NEUTRAL = rgb(255, 255, 255);
